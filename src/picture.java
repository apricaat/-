...
public class picture {
    ...
    static String task_15(int n) {
       if(n<10){
           return Integer.toString(n);
       }
       else{
           return n%10+" "+task_15(n/10);
       }
    }

    static void task_16(int max, int count) {
        java.util.Scanner in = new java.util.Scanner(System.in);
        int n = in.nextInt();
        if (n > 0) {
            if (n > max) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println( "\n15) Цифры числа справа налево. Дано натуральное число N. Выведите все его цифры по одной, в обычном порядке, разделяя их пробелами или новыми строками.");
        System.out.println("  Введи число: ");
        a = scanner.nextInt();
        System.out.print("  Результат: " + task_15(a));
